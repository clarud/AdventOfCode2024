...
def markNode(map, signal):
    ...
    def triangulate(pos1, pos2):
        ...
        if (pos1[0] < pos2[0] and pos1[1] < pos2[1]):
            newPos = (pos1[0] - diffRow,pos1[1]- diffCol)
        ...
        # vert
            ...
            if pos1[0] < pos2[0]:
                newPos = (pos1[0] - diffRow, pos1[1])
            else:
                newPos = (pos1[0] + diffRow, pos1[1])
        # horizontal
        elif (pos1[0] == pos2[0]):
            if pos1[1] < pos2[1]:
                newPos = (pos1[0], pos1[1] - diffCol)
            else:
                newPos = (pos1[0], pos1[1] + diffCol)
        # check valid positions
        if newPos[0] >= 0 and newPos[0] < len(map) and newPos[1] >= 0 and newPos[1] < len(map[0]):
            antinodes.append(newPos)
            antinodes.extend(triangulate(newPos, pos1))
        return antinodes
